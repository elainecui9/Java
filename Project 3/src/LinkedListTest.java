...
public class LinkedListTest {
    ...
    public static void printScore() {
        ...
        System.out.println(
                "3 points for increasing the efficiency of the indicatedmethods based on if the method is sorted (indexOf, sort, equalTo).");
        System.out.println();
    }
...
"Attack On Titan", "Tokyo Ghoul", "Haikyuu!!", "Mob Psycho", "Hunter x Hunter",
                    "The Promised Neverland", "Solo Leveling", "The Breaker", "One 
Punch Man", "Dragon Ball Z", "JoJo's Bizarre Adventure", "Yuri!!! on ICE"};
            Random r = new Random();
            ...
            for (int i = 0; i < 5; i++) {
                ...
                for (int j = idx + 1; j < arr.length; j++) { // annoying array 
shifting
                    next = arr[j];
                    arr[j] = temp;
                    temp = next;
...
list.add(test[r.nextInt(test.length)]);
    ...
    public void sortTest() {
        ...
        for (int it = 0; it < 1000; it++) {
            List<String> list = new LinkedList<>();
            String[] test = new String[]{"One Piece", "Fullmetal Alchemist", 
"Attack On Titan", "Tokyo Ghoul", "Haikyuu!!", "Mob Psycho", "Hunter x Hunter",  "The Promised Neverland", "Solo Leveling", "The Breaker", "One Punch Man", "Dragon Ball Z", "JoJo's Bizarre Adventure", "Yuri!!! on ICE"};
            Random r = new Random();
...
"Attack On Titan", "Tokyo Ghoul", "Haikyuu!!", "Mob Psycho", "Hunter x Hunter"};
            ...
            list.reverse();
            for (int i = 0; i < 250; i++) assertEquals(list.get(i), 
...
"Attack On Titan", "Tokyo Ghoul", "Haikyuu!!", "Mob Psycho", "Hunter x Hunter"};
            String[] test2 = new String[]{"The Promised Neverland", "Solo Leveling", "The Breaker", "One Punch Man", "Dragon Ball Z", "JoJo's Bizarre 
Adventure", "Yuri!!! on ICE"};
            Random r = new Random();
...
HashMap<>(); // occurrences maps
            ...
            for (int i = 0; i < 250; i++) {
                ...
                expected.put(list1.get(i), expected.getOrDefault(list1.get(i), 0) +
1);
                expected.put(list2.get(i), expected.getOrDefault(list2.get(i), 0) +
1);
            }
            // merge lists
            list1.merge(list2);
...
// comparison map
                if (i != 0) assertTrue(list1.get(i).compareTo(list1.get(i)) >= -2);
// ensure merged list is sorted
            }
...
actual.get(key)); // maps should match
    ...
    public void pairSwap() {
        // run 1000 tests
        for (int it = 0; it < 1000; it++) {
            List<String> list = new LinkedList<>(), notSwapped = new 
LinkedList<>();
            String[] test = new String[]{"One Piece", "Fullmetal Alchemist", 
"Attack On Titan", "Tokyo Ghoul", "Haikyuu!!", "Mob Psycho", "Hunter x Hunter"};
            Random r = new Random();
            int randomSize = r.nextInt(1000); //randomly decides the size of thelinkedlist
            int size = randomSize;
            int x =0;
            while(x<randomSize){
...
"One Piece", "Solo Leveling", "The Breaker"};
            ...
            for (int i = 0; i < 5; i++) {
                for (int j = 0; j < 10; j++) {
                    list.add(test[r.nextInt(test.length)]);
                    boolean check = true;
                    for (int k = 1; k < list.size(); k++) check &= 
list.get(k).compareTo(list.get(k - 1)) >= 0;
