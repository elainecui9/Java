...
public class ArrayListTest {
    ...
    public static void printScore() {
        System.out.println();
        System.out.println("ArrayList: " + SCORING_TEST_RULE.getPoints() + " / " +
    ...
    public void indexOfTest() {
        ...
        for (int it = 0; it < 1000; it++) {
            for (int i = 0; i < 3; i++) {
                ...
                String[] test = new String[] { "One Piece", "Fullmetal Alchemist",
                        "Attack On Titan", "Tokyo Ghoul", "Haikyuu!!", "Mob Psycho", "Hunter x Hunter",
                        "The Promised Neverland", "Solo Leveling", "The Breaker",
                        "One Punch Man", "Dragon Ball Z", "JoJo's Bizarre Adventure", "Yuri!!! on ICE" };
                Random r = new Random();
    ...
    public void equalToTest() {
        ...
        for (int it = 0; it < 1000; it++) {
            ...
            for (int i = 0; i < 250; i++)
                list.add(test[r.nextInt(test.length)]);
            for (int i = 0; i < 250; i++)
                if (list.get(i).equals("Haikyuu!!"))
                    size++;
            // ensure the size is updated and that all elements in the list were updated
            // accordingly
            list.equalTo("Haikyuu!!");
            assertEquals(size, list.size());
            for (int i = 0; i < size; i++)
                assertEquals("Haikyuu!!", list.get(i));
        }
    }
...
// comparison map
                if (i != 0) assertTrue(list1.get(i).compareTo(list1.get(i - 1)) >= 
0); // ensure merged list is sorted
            }
        ...
        for (int it = 0; it < 1000; it++) {
            ...
            if (size % 2 == 0) {
                for (int i = 1; i < size; i += 2) {
                    assertEquals(list.get(i - 1), notSwapped.get(i)); // case wherethe size is even, compares the two
                                                                      // positions that should be swapped
