...
public interface List<T extends Comparable<T>> {
     ...
     * Hint for ArrayList: You may find it useful to write a seperate
     * private method that does the growing and copying of the array
     *
     ...
     * When this function returns, the only elements that should be left in this
     * list
    ...
    /**
     * Reverses the list IN PLACE. Any use of intermediate data structures will
     * yield
     ...
     * Updates isSorted to true. You will have to cast otherList from a List<T>
     * type to a LinkedList<T>
     * or ArrayList<T> type.
     *
    ...
    /**
     * Pair swap takes the elements of the list in groups of two and swaps them.
     * This swap must be
     * down IN PLACE. Do not use any extra data structures to solve this problem.
     * If the number of
     * values is odd, then the last value in the list should stay in place.
     * For example, take the list [1,2,3,4,5]. Pair swap with return the list
     * [2,1,4,3,5].
     *
     */
    void pairSwap();
