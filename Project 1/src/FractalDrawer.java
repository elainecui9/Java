...
public class FractalDrawer {
    ...
    public double drawFractal(String type) {
        ...
        if (type.equals("Triangle")) {
            ...
            // if user enters "Triangle," prompt the user to enter the triangle's width,
            // height, and how many levels they would like
        ...
        if (type.equals("Circle")) {
            ...
            // if user enters "Circle," prompt the user to enter the circle's radius and how
            // many levels they would like
        }
        if (type.equals("Rectangle")) {
            ...
            // if user enters "Rectangle," prompt the user to enter the rectangle's width,
            // height, and how many levels they would like
        }
        return totalArea;
    ...
    public void drawTriangleFractal(double width, double height, double x, double y, Color c, Canvas can, int level) {
        ...
        // increment the total area of the fractal by the total area of the new
        // triangles drawn
        ...
        for (int colorChanger = 0; colorChanger < level; colorChanger++) {
            ...
            // cycles through the color of the shape being drawn depending on what level the
            // shape is being drawn on
        }
        if (level == 1) {
            can.drawShape(myTriangle);
            // draw a single triangle at level 1
        } else {
            drawTriangleFractal(width / 2, height / 2, myTriangle.getXPos() - width / 2, myTriangle.getYPos(),
                    currentColor, can, level - 1);
            drawTriangleFractal(width / 2, height / 2, myTriangle.getXPos() + width, myTriangle.getYPos(), currentColor,
                    can, level - 1);
            drawTriangleFractal(width / 2, height / 2, myTriangle.getXPos() + width / 4, myTriangle.getYPos() - height,
                    currentColor, can, level - 1);
            // decrease the dimensions of the triangle, change the x and y position of each
            // triangle, and change the color of the triangle for each level using recursion
            // draws a fractal pattern so that the next triangles aligns with the corners of
    ...
    public void drawCircleFractal(double radius, double x, double y, Color c, Canvas can, int level) {
        ...
        // creates a new circle object at point (x, y) with a radius determined by user
        // input
        myCircle.setColor(c);
        totalArea = totalArea + myCircle.calculateArea();
        // increment the total area of the fractal by the total area of every new
        // circles drawn
        ...
        // cycles through the colors so that circles of the same level have the same
        // color
        if (level == 1) {
            can.drawShape(myCircle);
            // draw a single circle at level 1, base case
        } else {
            drawCircleFractal(radius / 2, myCircle.getXPos() - radius * 1.5, myCircle.getYPos(), currentColor, can,
                    level - 1);
            drawCircleFractal(radius / 2, myCircle.getXPos(), myCircle.getYPos() + radius * 1.5, currentColor, can,
                    level - 1);
            drawCircleFractal(radius / 2, myCircle.getXPos() + radius * 1.5, myCircle.getYPos(), currentColor, can,
                    level - 1);
            drawCircleFractal(radius / 2, myCircle.getXPos(), myCircle.getYPos() - radius * 1.5, currentColor, can,
        ...
        // recusion to call the method again in order to draw the circles with half the
        // radius
    ...
    public void drawRectangleFractal(double width, double height, double x, double y, Color c, Canvas can, int level) {
        ...
        // creates a new circle object at point (x, y) with a width and height
        // determined by user input
        totalArea = totalArea + myRectangle.calculateArea();
        // adding together the area of the rectangle and the previous rectangles that
        // were calculated through the set height and width
        ...
        if (level == 1) {
            can.drawShape(myRectangle);
            // base case for the recursion, so the single rectangle will just be drawn at
            // level 1
        } else {
            drawRectangleFractal(width / 2, height / 2, myRectangle.getXPos() - width * 0.25,
                    myRectangle.getYPos() - height * 0.25, currentColor, can, level - 1);
            drawRectangleFractal(width / 2, height / 2, myRectangle.getXPos() - width * 0.25,
                    myRectangle.getYPos() + height * 0.75, currentColor, can, level - 1);
            drawRectangleFractal(width / 2, height / 2, myRectangle.getXPos() + width * 0.75,
                    myRectangle.getYPos() + height * 0.75, currentColor, can, level - 1);
            drawRectangleFractal(width / 2, height / 2, myRectangle.getXPos() + width * 0.75,
                    myRectangle.getYPos() - height * 0.25, currentColor, can, level - 1);
        }
        // calling of own method while halving the width and height of the rectangle in
        // order to the fractal pattern while updating the color, position , and level;
    }
